...
class HybridSampler:
    ...
    def hybrid_sampling(self, data_pairs, target_size=100000, method="fast"):
        ...
        if method == "fast":
            ...
            # greedy_samples, covered_units = self.frequency_based_sampling(data_pairs, 0)
        # elif method == "batched":
        ...
        # stratified_samples = self.stratified_sampling(remaining_data, 0)
